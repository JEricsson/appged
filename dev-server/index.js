...
if (!fs.existsSync(distPath)) {
  console.error("\x1b[31m%s\x1b[0m", "Error: 'dist' pasta não encontrada!");
  console.log("\nPor favor, crie o projeto primeiro executando:");
...
// Routes
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, "../samples/appged.html"));
});
...
httpServer.listen(httpPort, () => {
  console.log("\n\x1b[1m appGED - Capturar Documentos\x1b[0m\n");
  console.log("\x1b[36m HTTP URLs:\x1b[0m");
  console.log("\x1b[90m-------------------\x1b[0m");
  console.log("\x1b[33m App GED:\x1b[0m    http://localhost:" + httpPort + "/appged");
...
httpsServer.listen(httpsPort, "0.0.0.0", () => {
  ...
  ipv4Addresses.forEach((localIP) => {
    console.log("\x1b[32m App GED:\x1b[0m  https://" + localIP + ":" + httpsPort + "/appged");
    console.log("\x1b[32m Demo:\x1b[0m  https://" + localIP + ":" + httpsPort + "/demo");
  });
  console.log("\n");
  console.log("\x1b[90mPressione Ctrl+C para parar o servidor\x1b[0m\n");
});
